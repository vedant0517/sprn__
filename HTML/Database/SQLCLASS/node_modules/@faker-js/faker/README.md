...
[Open in StackBlitz](https://v10.fakerjs.dev/new)

## 📙 API Documentation

- [Getting Started Guide](https://v10.fakerjs.dev/guide/)
- [API Reference](https://v10.fakerjs.dev/api/)
...
An in-depth overview of the API methods is available in the documentation for [v10 (stable)](https://v10.fakerjs.dev/api/) and [v10.\* (next)](https://next.fakerjs.dev/api/).
...
See our documentation for a list of [provided languages](https://v10.fakerjs.dev/guide/localization.html#available-locales).
...
If you want consistent results, you can set your own seed. If you are using `faker.date` methods, there are additional considerations. See [Reproducible Results](https://v10.fakerjs.dev/guide/usage.html#reproducible-results).
...
Read the [team update](https://v10.fakerjs.dev/update.html) (January 14th, 2022).
